  ...
  return (
    <div className="honor-card p-6">
      <div className="flex items-center mb-4 text-amber-600">
        ...
        <h2 className="text-xl font-bold">Эскалация задания</h2>
      </div>
      
      {taskTitle && (
        <p className="mb-4 text-honor-darkGray">
          Задание: <span className="font-medium text-honor-text">{taskTitle}</span>
        </p>
      )}
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <Textarea
            ...
            placeholder="Укажите причину эскалации задания..."
